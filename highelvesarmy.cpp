#include "highelvesarmy.h"

HighElvesArmy::HighElvesArmy() :
  IArmy(nullptr)
{
...
const QStringList &HighElvesArmy::getUnits()
{
  return m_Units;
}

void HighElvesArmy::buildUiForBattleScroll(QQuickView *ui, int scrollIndex)
{
