#include "orcsandgoblinsarmy.h"

OrcsAndGoblinsArmy::OrcsAndGoblinsArmy() :
  IArmy(nullptr)
{
...
const QStringList &OrcsAndGoblinsArmy::getUnits()
{
  return m_Units;
}

void OrcsAndGoblinsArmy::buildUiForBattleScroll(QQuickView *ui, int scrollIndex)
{
