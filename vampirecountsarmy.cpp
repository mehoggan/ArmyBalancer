#include "vampirecountsarmy.h"

VampireCountsArmy::VampireCountsArmy() :
  IArmy(nullptr)
{
...
const QStringList &VampireCountsArmy::getUnits()
{
  return m_Units;
}

void VampireCountsArmy::buildUiForBattleScroll(QQuickView *ui, int scrollIndex)
{
