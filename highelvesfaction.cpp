  ...
  IFaction(nullptr)
{
  ...
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::High_Elf_Prince_on_Griffon, m_Units.back()));
  m_Units.push_back(tr("High Elf Prince on Dragon"));
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::High_Elf_Prince_on_Dragon, m_Units.back()));
  m_Units.push_back(tr("High Elf Archmage on Dragon"));
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::High_Elf_Archmage_on_Dragon, m_Units.back()));
  ...
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::High_Elf_Repeater_Bolt_Thrower, m_Units.back()));
  m_Units.push_back(tr("Great Eagles"));
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::Great_Eagles_in_High_Elves, m_Units.back()));
  m_Units.push_back(tr("Alith Anar, The Shadow King"));
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::Alith_Anar_The_Shadow_King, m_Units.back()));
  ...
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::Handmaiden_of_the_Everqueen, m_Units.back()));
  ...
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::High_Elf_Swordmasters_of_Hoeth, m_Units.back()));
  ...
  m_NameToWarScroll.insert(m_Units.back(),
    std::bind(&WarScrollGeneration::Lothern_Sea_Helm_on_Skycutter, m_Units.back()));
