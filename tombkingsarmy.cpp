#include "tombkingsarmy.h"

TombKingsArmy::TombKingsArmy() :
  IArmy(nullptr)
...
const QStringList &TombKingsArmy::getUnits()
{
  return m_Units;
}

void TombKingsArmy::buildUiForBattleScroll(QQuickView *ui, int scrollIndex)
{
